...
const Perfil = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-purple-600 relative">
      ...
      <div className="flex-1 bg-gray-100 rounded-t-3xl flex flex-col items-center px-6 py-10 overflow-y-auto">
        <div className="relative w-40 h-40 flex items-center justify-center mb-8 mt-6">
            <div className="absolute w-48 h-48 bg-orange-400 rounded-full -z-10" />
            <img
            src={
                user?.avatar_url ||
